        ...
        <div class="max-w-2xl w-full">
            ...
            <div class="text-center mb-12">
                <div class="inline-block relative">
                    ...
                    <!-- Logo -->
                    <div class="relative w-20 h-20 mx-auto bg-gradient-to-br from-[#4a6b5a] to-[#5a7a6a] rounded-2xl flex items-center justify-center shadow-xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4 verification-step opacity-0" data-step="1">
                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#4a6b5a] to-[#5a7a6a] rounded-full flex items-center justify-center text-white font-bold step-icon">
                            <span class="step-number">1</span>
                            <svg class="w-6 h-6 hidden step-check" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-2 h-1 bg-gray-200 rounded-full overflow-hidden">
                                <div class="h-full bg-gradient-to-r from-[#4a6b5a] to-[#d4b896] rounded-full step-progress w-0"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 verification-step opacity-0" data-step="2">
                        <div class="flex-shrink-0 w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-400 font-bold step-icon">
                    ...
                    <div class="flex items-start gap-4 verification-step opacity-0" data-step="3">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-gray-400 mb-1">تحليل التشابه الدلالي بالذكاء الاصطناعي</h3>
            ...
            <div class="text-center">
                <div class="bg-gradient-to-r from-[#4a6b5a]/10 to-[#d4b896]/10 rounded-xl p-6 border-r-4 border-[#4a6b5a]">
