...
<body class="bg-white font-sans pt-20 scroll-smooth">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <div
                    ...
                    <div
                        class="w-full h-48 bg-gradient-to-r bg-primary rounded-xl mb-6 flex items-center justify-center">
    ...
    <section id="contact" class="py-20 bg-[#f8f6f0]">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-center text-[#4a6b5a] mb-6">{{ __('home.contact_title') }}
            </h2>
            <p class="text-center text-gray-600 mb-16 text-lg">
