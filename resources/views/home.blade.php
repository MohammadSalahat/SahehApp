...
<head>
    ...
    <title>{{ __('home.welcome') }} - {{ __('home.hero_title') }}</title>
...
<body class="bg-white font-sans pt-20 scroll-smooth">
    ...
    <section class="bg-[#f8f6f0] py-24 relative overflow-hidde">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
            <h1 class="text-5xl md:text-7xl font-bold text-primary mb-6 leading-tight">
                {{ __('home.welcome') }}
            </h1>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                <button
                    class="bg-gradient-to-r from-primary to-[#5a7a6a] text-white px-10 py-4 rounded-xl text-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-3">
                ...
                <button
                    class="bg-white border-2 border-primary text-primary px-10 py-4 rounded-xl text-lg font-bold hover:bg-primary hover:text-white hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 shadow-lg">
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-center text-primary mb-6">
                {{ __('home.latest_news') }}
            </h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <div
                    ...
                    <button
                        class="w-full bg-gradient-to-r from-primary to-[#5a7a6a] text-white py-3 rounded-lg font-medium shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-10 relative overflow-hidden">
                ...
                <form id="verification-form" action="{{ route('verify') }}" method="POST"
                    ...
                    <textarea id="news-content" name="content" required minlength="20"
                        class="w-full h-48 p-6 border-2 border-gray-200 rounded-xl focus:border-primary focus:outline-none resize-none text-lg leading-relaxed transition-all duration-300 focus:shadow-lg focus:ring-2 focus:ring-primary/20"
                        placeholder="{{ __('home.news_text_placeholder') }}">{{ old('content') }}</textarea>

                    <button type="submit" id="submit-btn"
                        class="bg-gradient-to-r from-primary to-[#5a7a6a] text-white w-full mt-8 py-5 rounded-xl text-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                <div
                    ...
                    <div
                        class="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6 pulse-soft">
                        <svg class="w-10 h-10 text-primary" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-primary mb-4">{{ __('home.source_1_title') }}</h3>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-primary mb-4">{{ __('home.source_2_title') }}</h3>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-primary mb-4">{{ __('home.source_3_title') }}</h3>
                    <p class="text-gray-700 leading-relaxed">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div
                    ...
                    <h3 class="text-2xl font-bold text-primary mb-4">{{ __('home.source_4_title') }}</h3>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-primary mb-4">{{ __('home.source_5_title') }}</h3>
                    <p class="text-gray-700 leading-relaxed">
    ...
    <section id="about" class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-5xl text-center">
            <h2 class="text-4xl md:text-5xl font-bold text-primary mb-12">{{ __('home.about_title') }}</h2>
    ...
    <button id="scrollToTop"
        class="fixed bottom-8 left-8 bg-primary text-white p-4 rounded-full shadow-xl hover:bg-primary/90 transition-all duration-300 opacity-0 pointer-events-none hover:scale-110 hover:-translate-y-1">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
