<div class="bg-white rounded-3xl shadow-xl p-8 border-t-4 border-primary">
    ...
    @if (!$submitted)
        ...
        @else
            <div class="text-center">
                <p class="text-primary text-lg mb-6 font-medium">
                    أنت مسجل دخول! يمكنك الآن تقييم نتيجة التحقق
                </p>

                <a href="{{ route('review') }}"
                    class="bg-gradient-to-r from-primary to-[#5a7a6a] text-white px-10 py-4 rounded-xl text-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 inline-flex items-center justify-center gap-3">
