<x-layouts.auth>
    <div
        ...
        <div
            class="absolute top-20 left-1/2 transform -translate-x-1/2 w-72 h-72 bg-[#4a6b5a]/10 rounded-full blur-3xl">
        </div>
        <div
        ...
        <div class="max-w-md w-full space-y-8 relative z-10">
            ...
            <div class="text-center">
                ...
                <h2 class="text-4xl font-bold text-[#4a6b5a] mb-2">تأكيد كلمة المرور</h2>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <form method="POST" action="{{ route('password.confirm.store') }}" class="flex flex-col gap-6">
                        ...
                        <flux:button variant="primary" type="submit"
                            class="w-full bg-gradient-to-r from-[#4a6b5a] to-[#5a7a6a] text-white py-4 rounded-xl text-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3"
