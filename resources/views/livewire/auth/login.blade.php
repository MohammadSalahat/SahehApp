<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
            ...
            <form method="POST" wire:submit="login" class="space-y-6">
                ...
                <div>
                    ...
                    <input wire:model="email" id="email" type="email" required autofocus autocomplete="email"
                        ...
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:outline-none transition-all duration-300 focus:ring-2 focus:ring-primary/20" />
                    @error('email')
                    ...
                    <div class="flex items-center justify-between mb-2">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" wire:navigate
                                class="text-sm text-primary hover:text-[#d4b896] transition-colors duration-300">
                ...
                <button type="submit" data-test="login-button"
                    class="w-full bg-gradient-to-r from-primary to-[#5a7a6a] text-white py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2">
            ...
            @if (Route::has('register'))
                <div class="mt-6 text-center">
                    ...
                    <a href="{{ route('register') }}" wire:navigate
                        class="text-primary hover:text-[#d4b896] font-semibold transition-colors duration-300 mr-1">
        ...
        <div class="mt-6 text-center">
            <a href="/"
                class="inline-flex items-center gap-2 text-primary hover:text-[#d4b896] transition-colors duration-300">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
